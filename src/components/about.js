      ...
      <div className="container flex justify-center flex-col-reverse px-[20px] md:flex-row py-1 md:pt-40 gap-[30px]  ">
        ...
        <div data-aos="fade-up" className="flex flex-col  gap-3">
          ...
          <div className="flex md:flex-row flex-col  gap-2">
            <div class="w-full rounded-full bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-1  cursor-pointer">
              <div class=" rounded-full flex h-full w-full  bg-white back hover:bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500">
                <h2 class="text-[1.25rem] text-black px-4 py-1">
          ...
          <div  data-aos="zoom-in-right" class="bg-slate-50 cursor-pointer rounded-md max-w-25 hover:bg-slate-200">
            ...
            <div data-aos="zoom-in-up" class="bg-slate-50 hover:bg-slate-200 cursor-pointer rounded-md max-w-25">
              <div className="py-3 px-4">
                <h3 className="text-center font-bold text-[1.75rem]">
                  10+
                </h3>
            ...
            <div  data-aos="zoom-in-left" class="bg-slate-50 hover:bg-slate-200 cursor-pointer rounded-md max-w-25">
              <div className="py-3 px-4">
                <h3 className="text-center font-bold text-[1.75rem]">
                  24/7
                </h3>
